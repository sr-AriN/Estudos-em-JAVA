...
//Programa totalmete copiado para estudo.
...
public class Desafio {
    ...
    // Método que irá gerar os números aleatórios simulando o lançamento de um dado
    // 100 vezes.
    ...
    // Método que irá organizar os resultados dos lançamenots em grupos de 1 a 6
    // (resultados possíveis de um dado)
    private static Map<Integer, Integer> lancamentosOrganizados(List<Integer> lancamentosDeDados) {
        // Map que irá armazenar os resultados dos lançamentos de acordo com o
        // resultado.
        Map<Integer, Integer> resultadoDosLancamentosOrganizados = new HashMap<Integer, Integer>();

        // Vamos pegar a lista com todos os lançamentos e organizar dentro de um map
        // chave e valor.
        for (Integer resultadoDoLancamento : lancamentosDeDados) {
            // Se ao navegar na lista, o elemento armazenado na lista (que é o resultado do
            // lançamento) já tiver aparecido:
            if (resultadoDosLancamentosOrganizados.containsKey(resultadoDoLancamento)) {
                // Pega esse resultado e coloca dentro do Map como key e informa, acrescentando
                // +1 no value para indicar que esse resultado apareceu mais uma vez.
                resultadoDosLancamentosOrganizados.put(resultadoDoLancamento,
                        (resultadoDosLancamentosOrganizados.get(resultadoDoLancamento) + 1));
            } else { // Se foi a primeira vez que o resultado apareceu na lista
                // Pega esse resultado e coloca como key de um elemento do Map, e informa no
                // valor que ele apareceu pela primeira vez, indicando 1.
    ...
    private static void exibindoResultadoDosLancamentosAgrupados(
            Map<Integer, Integer> resuldadoDosLancamentosAgrupados) {
        ...
        for (Map.Entry<Integer, Integer> entry : resuldadoDosLancamentosAgrupados.entrySet()) {
            ...
            // Pegando Key (Valor da face do dado) e Value (quantas vezes deu o número dessa
