...
public class RefatoracaoOrdenacaoMap {
    public static void main(String[] args) {
         ...
         * 
         * @Override
         * public int compare(Entry<Integer, Contato> count1, Entry<Integer, Contato>
         * count2) {
         * return
         * count1.getValue().getNumero().compareTo(count2.getValue().getNumero());
         * }
         * 
         * });
         */
         ...
         * 
         * @Override
         * public Integer apply(Entry<Integer, Contato> count) {
         * return count.getValue().getNumero();
         * }
         * 
         * }));
         */
        Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(
                Comparator.comparing(count -> count.getValue().getNumero()));
         ...
         * 
         * @Override
         * public int compare(Entry<Integer, Contato> nome1, Entry<Integer, Contato>
         * nome2) {
         ...
         * 
         * @Override
         * public String apply(Entry<Integer, Contato> nome) {
